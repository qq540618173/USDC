<template>
	<view class="notice">
		<header-bar :isBack="isBack" :isBlankBack="isBlankBack" :title="title?title:i18n.header.header18"></header-bar>
		<view class="container" v-if="newsDetail.title">
			<view class="title">
		...
		<view class="container" v-if="qaList.content">
			<view class="notice-wrap">
